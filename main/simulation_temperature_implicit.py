...
import matplotlib
from do_implicit_simulation import run_model
...
INCLUDE_ENTRAINMENT_VEL_ANOMALY_FORCING = False  # CHENGYUN comment: don't change this.
...
USE_DOWNLOADED_SSH = False  # CHENGYUN comment: don't change this.
USE_OTHER_MLD = False  # CHENGYUN comment: don't change this.
USE_MAX_GRADIENT_METHOD = True
USE_LOG_FOR_ENTRAINMENT = False
DATA_TO_2025 = True  # CHENGYUN comment: don't change this.
rho_0 = 1025.0
c_0 = 4100.0
gamma_0 = 15.0
g = 9.81
