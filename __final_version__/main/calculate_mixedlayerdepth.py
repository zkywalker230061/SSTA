...
def save_mld():
    ...
    with open("logs/datasets.txt", "r", encoding="utf-8") as logs_datasets:
        if "datasets/Mixed_Layer_Depth-(2004-2025).nc" in logs_datasets.read():
            return
...
def save_monthly_mean_mld():
    ...
    with open("logs/datasets.txt", "r", encoding="utf-8") as logs_datasets:
        if "datasets/Mixed_Layer_Depth-Clim_Mean.nc" in logs_datasets.read():
            return
