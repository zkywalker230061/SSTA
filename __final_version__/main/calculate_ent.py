...
def save_monthly_mean_sub_temperature():
    ...
    with open("logs/datasets.txt", "r", encoding="utf-8") as logs_datasets:
        if "datasets/Sub_Layer_Temperature-Clim_Mean.nc" in logs_datasets.read():
            return
    ...
    save_file(
        t_sub_monthly_mean,
        'datasets/Sub_Layer_Temperature-Clim_Mean.nc'
    )
...
def save_monthly_mean_sub_salinity():
    ...
    with open("logs/datasets.txt", "r", encoding="utf-8") as logs_datasets:
        if "datasets/Sub_Layer_Salinity-Clim_Mean.nc" in logs_datasets.read():
            return
    ...
    save_file(
        s_sub_monthly_mean,
        'datasets/Sub_Layer_Salinity-Clim_Mean.nc'
    )
...
def save_sub_temperature_anomalies():
    ...
    with open("logs/datasets.txt", "r", encoding="utf-8") as logs_datasets:
        if "datasets/Sub_Layer_Temperature_Anomalies-(2004-2025).nc" in logs_datasets.read():
            return
...
def save_sub_salinity_anomalies():
    ...
    with open("logs/datasets.txt", "r", encoding="utf-8") as logs_datasets:
        if "datasets/Sub_Layer_Salinity_Anomalies-(2004-2025).nc" in logs_datasets.read():
            return
...
def save_entrainment_velocity():
    ...
    with open("logs/datasets.txt", "r", encoding="utf-8") as logs_datasets:
        if "datasets/Mixed_Layer_Entrainment_Velocity-(2004-2025).nc" in logs_datasets.read():
            return
    ...
    w_e_da.attrs['long_name'] = (
        'Monthly Entrainment Velocity Jan 2004 - Dec 2025 (22.0 year)'
    )

    save_file(
        w_e_da,
        'datasets/Mixed_Layer_Entrainment_Velocity-(2004-2025).nc'
    )
...
def save_monthly_mean_entrainment_velocity():
    ...
    with open("logs/datasets.txt", "r", encoding="utf-8") as logs_datasets:
        if "datasets/Mixed_Layer_Entrainment_Velocity-Clim_Mean.nc" in logs_datasets.read():
            return
...
def save_entrainment_anomaly_temperature():
    ...
    with open("logs/datasets.txt", "r", encoding="utf-8") as logs_datasets:
        if "datasets/Simulation-Entrainment_Heat_Flux-(2004-2025).nc" in logs_datasets.read():
            return
    ...
    q_entrainment_a.attrs['long_name'] = (
        'Monthly Q_Entrainment Anomaly Jan 2004 - Dec 2025 (22.0 year)'
    )
...
def save_entrainment_anomaly_salinity():
    ...
    with open("logs/datasets.txt", "r", encoding="utf-8") as logs_datasets:
        if "datasets/Simulation-Entrainment_Water_Rate-(2004-2025).nc" in logs_datasets.read():
            return
    ...
    q_entrainment_salt_a.attrs['long_name'] = (
        'Monthly Q_Entrainment Water Rate Anomaly Jan 2004 - Dec 2025 (22.0 year)'
    )
...
def save_entrainment_anomaly_temperature_maxgrad():
    """Save the Q_Entrainment dataset for temperature."""

    with open("logs/datasets.txt", "r", encoding="utf-8") as logs_datasets:
        if "datasets/Simulation-Entrainment_Heat_Flux_Max_Gradient-(2004-2025).nc" in logs_datasets.read():
            return
