...
def save_monthly_mean_surface_heat_flux():
    ...
    with open("logs/datasets.txt", "r", encoding="utf-8") as logs_datasets:
        if "datasets/Surface_Heat_Flux-Clim_Mean.nc" in logs_datasets.read():
            return

    q_surface_ds = load_and_prepare_dataset(
        "datasets/Surface_Heat_Flux-(2004-2025).nc"
    )
    ...
    save_file(
        ...
        "datasets/Surface_Heat_Flux-Clim_Mean.nc"
    )
...
def save_monthly_mean_surface_water_rate():
    ...
    with open("logs/datasets.txt", "r", encoding="utf-8") as logs_datasets:
        if "datasets/Surface_Water_Rate-Clim_Mean.nc" in logs_datasets.read():
            return

    q_surface_ds = load_and_prepare_dataset(
        "datasets/Surface_Water_Rate-(2004-2025).nc"
    )
...
def save_surface_heat_flux_anomalies():
    ...
    with open("logs/datasets.txt", "r", encoding="utf-8") as logs_datasets:
        if "datasets/Surface_Heat_Flux_Anomalies-(2004-2025).nc" in logs_datasets.read():
            return
    ...
    save_file(
        q_surface_a_ds,
        "datasets/Surface_Heat_Flux_Anomalies-(2004-2025).nc"
    )
...
def save_surface_water_rate_anomalies():
    ...
    with open("logs/datasets.txt", "r", encoding="utf-8") as logs_datasets:
        if "datasets/Surface_Water_Rate_Anomalies-(2004-2025).nc" in logs_datasets.read():
            return
    ...
    save_file(
        q_surface_a_ds,
        "datasets/Surface_Water_Rate_Anomalies-(2004-2025).nc"
    )
...
def save_surface_anomaly_temperature():
    ...
    with open("logs/datasets.txt", "r", encoding="utf-8") as logs_datasets:
        if "datasets/Simulation-Surface_Heat_Flux-(2004-2025).nc" in logs_datasets.read():
            return
...
def save_surface_anomaly_salinity():
    ...
    with open("logs/datasets.txt", "r", encoding="utf-8") as logs_datasets:
        if "datasets/Simulation-Surface_Water_Rate-(2004-2025).nc" in logs_datasets.read():
            return
