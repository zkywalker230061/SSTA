...
from _entrainment_vel_anomaly_forcing import entrainment_vel_anomaly_forcing
from _utils import make_movie, get_eof_with_nan_consideration, remove_empty_attributes, get_save_name, \
    coriolis_parameter, get_month_from_time
from _utils import get_monthly_mean, get_anomaly, load_and_prepare_dataset
...
def run_model(INCLUDE_SURFACE, INCLUDE_EKMAN_ANOM_ADVECTION, INCLUDE_EKMAN_MEAN_ADVECTION, INCLUDE_ENTRAINMENT, INCLUDE_ENTRAINMENT_VEL_ANOMALY_FORCING, INCLUDE_GEOSTROPHIC_ANOM_ADVECTION, INCLUDE_GEOSTROPHIC_MEAN_ADVECTION, USE_MAX_GRADIENT_METHOD, USE_LOG_FOR_ENTRAINMENT):
    ...
    HEAT_FLUX_ALL_CONTRIBUTIONS_DATA_PATH = "datasets/Chris/heat_flux_interpolated_all_contributions.nc"
    EKMAN_ANOMALY_DATA_PATH = "datasets/Chris/Ekman_Current_Anomaly.nc"
    ...
    GEOSTROPHIC_ANOMALY_CALCULATED_DATA_PATH = "datasets/Chris/geostrophic_anomaly_calculated.nc"
    EKMAN_MEAN_ADVECTION_DATA_PATH = "datasets/Chris/ekman_mean_advection.nc"
    ENTRAINMENT_VEL_ANOMALY_FORCING_DATA_PATH = "datasets/Chris/entrainment_velocity_anomaly_forcing.nc"
    ...
    if USE_MAX_GRADIENT_METHOD:
        T_SUB_DATA_PATH = "datasets/Chris/Tsub_Max_Gradient_Method_h.nc"
    ...
    if USE_OTHER_MLD:
        ...
        t_sub_da_monthly_mean = get_monthly_mean(t_sub_da)
        t_sub_da = get_anomaly(t_sub_ds, "SUB_TEMPERATURE", t_sub_da_monthly_mean)["SUB_TEMPERATURE_ANOMALY"]
    ...
    SEA_SURFACE_GRAD_DATA_PATH = "datasets/Chris/sea_surface_calculated_grad.nc"
    SEA_SURFACE_MONTHLY_MEAN_DATA_PATH = "datasets/Chris/sea_surface_monthly_mean_calculated_grad.nc"
    ssh_var_name = "ssh"
    ...
    model_anomalies_ds.to_netcdf("datasets/Simulation-Implicit/" + save_name + ".nc")
    ...
    flux_components_ds.to_netcdf("datasets/Simulation-Implicit/" + save_name + "_flux_components.nc")

    #make_movie(model_anomalies_ds["IMPLICIT"], -3, 3)


#run_model(INCLUDE_SURFACE, INCLUDE_EKMAN_ANOM_ADVECTION, INCLUDE_EKMAN_MEAN_ADVECTION, INCLUDE_ENTRAINMENT, INCLUDE_ENTRAINMENT_VEL_ANOMALY_FORCING, INCLUDE_GEOSTROPHIC_ANOM_ADVECTION, INCLUDE_GEOSTROPHIC_MEAN_ADVECTION, USE_DOWNLOADED_SSH, USE_OTHER_MLD, USE_MAX_GRADIENT_METHOD, USE_LOG_FOR_ENTRAINMENT)

# geo only
# run_model(INCLUDE_SURFACE=False, INCLUDE_EKMAN_ANOM_ADVECTION=False, INCLUDE_EKMAN_MEAN_ADVECTION=False, INCLUDE_ENTRAINMENT=False, INCLUDE_ENTRAINMENT_VEL_ANOMALY_FORCING=False, INCLUDE_GEOSTROPHIC_ANOM_ADVECTION=True, INCLUDE_GEOSTROPHIC_MEAN_ADVECTION=False, USE_DOWNLOADED_SSH=False, USE_OTHER_MLD=False, USE_MAX_GRADIENT_METHOD=False, USE_LOG_FOR_ENTRAINMENT=False)

# entrainment only
# run_model(INCLUDE_SURFACE=False, INCLUDE_EKMAN_ANOM_ADVECTION=False, INCLUDE_EKMAN_MEAN_ADVECTION=False, INCLUDE_ENTRAINMENT=True, INCLUDE_ENTRAINMENT_VEL_ANOMALY_FORCING=False, INCLUDE_GEOSTROPHIC_ANOM_ADVECTION=False, INCLUDE_GEOSTROPHIC_MEAN_ADVECTION=False, USE_DOWNLOADED_SSH=False, USE_OTHER_MLD=False, USE_MAX_GRADIENT_METHOD=False, USE_LOG_FOR_ENTRAINMENT=False)
# run_model(INCLUDE_SURFACE=False, INCLUDE_EKMAN_ANOM_ADVECTION=False, INCLUDE_EKMAN_MEAN_ADVECTION=False, INCLUDE_ENTRAINMENT=True, INCLUDE_ENTRAINMENT_VEL_ANOMALY_FORCING=True, INCLUDE_GEOSTROPHIC_ANOM_ADVECTION=False, INCLUDE_GEOSTROPHIC_MEAN_ADVECTION=False, USE_DOWNLOADED_SSH=False, USE_OTHER_MLD=False, USE_MAX_GRADIENT_METHOD=False, USE_LOG_FOR_ENTRAINMENT=False)

# log for entrainment
# run_model(INCLUDE_SURFACE=False, INCLUDE_EKMAN_ANOM_ADVECTION=False, INCLUDE_EKMAN_MEAN_ADVECTION=False, INCLUDE_ENTRAINMENT=True, INCLUDE_ENTRAINMENT_VEL_ANOMALY_FORCING=False, INCLUDE_GEOSTROPHIC_ANOM_ADVECTION=False, INCLUDE_GEOSTROPHIC_MEAN_ADVECTION=False, USE_DOWNLOADED_SSH=False, USE_OTHER_MLD=False, USE_MAX_GRADIENT_METHOD=False, USE_LOG_FOR_ENTRAINMENT=True)
# run_model(INCLUDE_SURFACE=True, INCLUDE_EKMAN_ANOM_ADVECTION=True, INCLUDE_EKMAN_MEAN_ADVECTION=True, INCLUDE_ENTRAINMENT=True, INCLUDE_ENTRAINMENT_VEL_ANOMALY_FORCING=False, INCLUDE_GEOSTROPHIC_ANOM_ADVECTION=True, INCLUDE_GEOSTROPHIC_MEAN_ADVECTION=True, USE_DOWNLOADED_SSH=False, USE_OTHER_MLD=False, USE_MAX_GRADIENT_METHOD=False, USE_LOG_FOR_ENTRAINMENT=True)
...
"""MAX_GRADIENT:"""
# full
# run_model(INCLUDE_SURFACE=True, INCLUDE_EKMAN_ANOM_ADVECTION=True, INCLUDE_EKMAN_MEAN_ADVECTION=True, INCLUDE_ENTRAINMENT=True, INCLUDE_ENTRAINMENT_VEL_ANOMALY_FORCING=False, INCLUDE_GEOSTROPHIC_ANOM_ADVECTION=True, INCLUDE_GEOSTROPHIC_MEAN_ADVECTION=True, USE_DOWNLOADED_SSH=False, USE_OTHER_MLD=False, USE_MAX_GRADIENT_METHOD=True, USE_LOG_FOR_ENTRAINMENT=False)

# run_model(INCLUDE_SURFACE=True, INCLUDE_EKMAN_ANOM_ADVECTION=True, INCLUDE_EKMAN_MEAN_ADVECTION=False, INCLUDE_ENTRAINMENT=True, INCLUDE_ENTRAINMENT_VEL_ANOMALY_FORCING=False, INCLUDE_GEOSTROPHIC_ANOM_ADVECTION=True, INCLUDE_GEOSTROPHIC_MEAN_ADVECTION=False, USE_DOWNLOADED_SSH=False, USE_OTHER_MLD=False, USE_MAX_GRADIENT_METHOD=True, USE_LOG_FOR_ENTRAINMENT=False)

# log for entrainment
# run_model(INCLUDE_SURFACE=False, INCLUDE_EKMAN_ANOM_ADVECTION=False, INCLUDE_EKMAN_MEAN_ADVECTION=False, INCLUDE_ENTRAINMENT=True, INCLUDE_ENTRAINMENT_VEL_ANOMALY_FORCING=False, INCLUDE_GEOSTROPHIC_ANOM_ADVECTION=False, INCLUDE_GEOSTROPHIC_MEAN_ADVECTION=False, USE_DOWNLOADED_SSH=False, USE_OTHER_MLD=False, USE_MAX_GRADIENT_METHOD=True, USE_LOG_FOR_ENTRAINMENT=True)
# run_model(INCLUDE_SURFACE=True, INCLUDE_EKMAN_ANOM_ADVECTION=True, INCLUDE_EKMAN_MEAN_ADVECTION=True, INCLUDE_ENTRAINMENT=True, INCLUDE_ENTRAINMENT_VEL_ANOMALY_FORCING=False, INCLUDE_GEOSTROPHIC_ANOM_ADVECTION=True, INCLUDE_GEOSTROPHIC_MEAN_ADVECTION=True, USE_DOWNLOADED_SSH=False, USE_OTHER_MLD=False, USE_MAX_GRADIENT_METHOD=True, USE_LOG_FOR_ENTRAINMENT=True)

# without some parts
# run_model(INCLUDE_SURFACE=False, INCLUDE_EKMAN_ANOM_ADVECTION=True, INCLUDE_EKMAN_MEAN_ADVECTION=True, INCLUDE_ENTRAINMENT=True, INCLUDE_ENTRAINMENT_VEL_ANOMALY_FORCING=False, INCLUDE_GEOSTROPHIC_ANOM_ADVECTION=True, INCLUDE_GEOSTROPHIC_MEAN_ADVECTION=True, USE_DOWNLOADED_SSH=False, USE_OTHER_MLD=False, USE_MAX_GRADIENT_METHOD=True, USE_LOG_FOR_ENTRAINMENT=False)
# run_model(INCLUDE_SURFACE=True, INCLUDE_EKMAN_ANOM_ADVECTION=False, INCLUDE_EKMAN_MEAN_ADVECTION=False, INCLUDE_ENTRAINMENT=True, INCLUDE_ENTRAINMENT_VEL_ANOMALY_FORCING=False, INCLUDE_GEOSTROPHIC_ANOM_ADVECTION=True, INCLUDE_GEOSTROPHIC_MEAN_ADVECTION=True, USE_DOWNLOADED_SSH=False, USE_OTHER_MLD=False, USE_MAX_GRADIENT_METHOD=True, USE_LOG_FOR_ENTRAINMENT=False)
# run_model(INCLUDE_SURFACE=True, INCLUDE_EKMAN_ANOM_ADVECTION=True, INCLUDE_EKMAN_MEAN_ADVECTION=True, INCLUDE_ENTRAINMENT=False, INCLUDE_ENTRAINMENT_VEL_ANOMALY_FORCING=False, INCLUDE_GEOSTROPHIC_ANOM_ADVECTION=True, INCLUDE_GEOSTROPHIC_MEAN_ADVECTION=True, USE_DOWNLOADED_SSH=False, USE_OTHER_MLD=False, USE_MAX_GRADIENT_METHOD=True, USE_LOG_FOR_ENTRAINMENT=False)
# run_model(INCLUDE_SURFACE=True, INCLUDE_EKMAN_ANOM_ADVECTION=True, INCLUDE_EKMAN_MEAN_ADVECTION=True, INCLUDE_ENTRAINMENT=True, INCLUDE_ENTRAINMENT_VEL_ANOMALY_FORCING=False, INCLUDE_GEOSTROPHIC_ANOM_ADVECTION=False, INCLUDE_GEOSTROPHIC_MEAN_ADVECTION=False, USE_DOWNLOADED_SSH=False, USE_OTHER_MLD=False, USE_MAX_GRADIENT_METHOD=True, USE_LOG_FOR_ENTRAINMENT=False)


# build model from entrainment
# run_model(INCLUDE_SURFACE=False, INCLUDE_EKMAN_ANOM_ADVECTION=False, INCLUDE_EKMAN_MEAN_ADVECTION=False, INCLUDE_ENTRAINMENT=True, INCLUDE_ENTRAINMENT_VEL_ANOMALY_FORCING=False, INCLUDE_GEOSTROPHIC_ANOM_ADVECTION=False, INCLUDE_GEOSTROPHIC_MEAN_ADVECTION=False, USE_DOWNLOADED_SSH=False, USE_OTHER_MLD=False, USE_MAX_GRADIENT_METHOD=True, USE_LOG_FOR_ENTRAINMENT=False)
# run_model(INCLUDE_SURFACE=True, INCLUDE_EKMAN_ANOM_ADVECTION=False, INCLUDE_EKMAN_MEAN_ADVECTION=False, INCLUDE_ENTRAINMENT=True, INCLUDE_ENTRAINMENT_VEL_ANOMALY_FORCING=False, INCLUDE_GEOSTROPHIC_ANOM_ADVECTION=False, INCLUDE_GEOSTROPHIC_MEAN_ADVECTION=False, USE_DOWNLOADED_SSH=False, USE_OTHER_MLD=False, USE_MAX_GRADIENT_METHOD=True, USE_LOG_FOR_ENTRAINMENT=False)
# run_model(INCLUDE_SURFACE=True, INCLUDE_EKMAN_ANOM_ADVECTION=True, INCLUDE_EKMAN_MEAN_ADVECTION=False, INCLUDE_ENTRAINMENT=True, INCLUDE_ENTRAINMENT_VEL_ANOMALY_FORCING=False, INCLUDE_GEOSTROPHIC_ANOM_ADVECTION=False, INCLUDE_GEOSTROPHIC_MEAN_ADVECTION=False, USE_DOWNLOADED_SSH=False, USE_OTHER_MLD=False, USE_MAX_GRADIENT_METHOD=True, USE_LOG_FOR_ENTRAINMENT=False)
# run_model(INCLUDE_SURFACE=True, INCLUDE_EKMAN_ANOM_ADVECTION=True, INCLUDE_EKMAN_MEAN_ADVECTION=False, INCLUDE_ENTRAINMENT=True, INCLUDE_ENTRAINMENT_VEL_ANOMALY_FORCING=False, INCLUDE_GEOSTROPHIC_ANOM_ADVECTION=True, INCLUDE_GEOSTROPHIC_MEAN_ADVECTION=False, USE_DOWNLOADED_SSH=False, USE_OTHER_MLD=False, USE_MAX_GRADIENT_METHOD=True, USE_LOG_FOR_ENTRAINMENT=False)

# build model from surface
# run_model(INCLUDE_SURFACE=True, INCLUDE_EKMAN_ANOM_ADVECTION=False, INCLUDE_EKMAN_MEAN_ADVECTION=False, INCLUDE_ENTRAINMENT=False, INCLUDE_ENTRAINMENT_VEL_ANOMALY_FORCING=False, INCLUDE_GEOSTROPHIC_ANOM_ADVECTION=False, INCLUDE_GEOSTROPHIC_MEAN_ADVECTION=False, USE_DOWNLOADED_SSH=False, USE_OTHER_MLD=False, USE_MAX_GRADIENT_METHOD=True, USE_LOG_FOR_ENTRAINMENT=False)
# run_model(INCLUDE_SURFACE=True, INCLUDE_EKMAN_ANOM_ADVECTION=True, INCLUDE_EKMAN_MEAN_ADVECTION=False, INCLUDE_ENTRAINMENT=False, INCLUDE_ENTRAINMENT_VEL_ANOMALY_FORCING=False, INCLUDE_GEOSTROPHIC_ANOM_ADVECTION=False, INCLUDE_GEOSTROPHIC_MEAN_ADVECTION=False, USE_DOWNLOADED_SSH=False, USE_OTHER_MLD=False, USE_MAX_GRADIENT_METHOD=True, USE_LOG_FOR_ENTRAINMENT=False)
# run_model(INCLUDE_SURFACE=True, INCLUDE_EKMAN_ANOM_ADVECTION=True, INCLUDE_EKMAN_MEAN_ADVECTION=False, INCLUDE_ENTRAINMENT=False, INCLUDE_ENTRAINMENT_VEL_ANOMALY_FORCING=False, INCLUDE_GEOSTROPHIC_ANOM_ADVECTION=True, INCLUDE_GEOSTROPHIC_MEAN_ADVECTION=False, USE_DOWNLOADED_SSH=False, USE_OTHER_MLD=False, USE_MAX_GRADIENT_METHOD=True, USE_LOG_FOR_ENTRAINMENT=False)
# run_model(INCLUDE_SURFACE=True, INCLUDE_EKMAN_ANOM_ADVECTION=True, INCLUDE_EKMAN_MEAN_ADVECTION=False, INCLUDE_ENTRAINMENT=True, INCLUDE_ENTRAINMENT_VEL_ANOMALY_FORCING=False, INCLUDE_GEOSTROPHIC_ANOM_ADVECTION=True, INCLUDE_GEOSTROPHIC_MEAN_ADVECTION=False, USE_DOWNLOADED_SSH=False, USE_OTHER_MLD=False, USE_MAX_GRADIENT_METHOD=True, USE_LOG_FOR_ENTRAINMENT=False)
