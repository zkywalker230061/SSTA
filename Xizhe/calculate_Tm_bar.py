...
Temp_mld_bar = vertical_integral(ds_Tbar_monthly, dz, ds_h_bar_monthly)          #??????i changed here to -z_new
...
grad_Tfull_lat = compute_gradient_lat(Temp_mld_bar)
print('grad_Tfull_lat:\n',grad_Tfull_lat)
grad_Tfull_lon = compute_gradient_lon(Temp_mld_bar)
